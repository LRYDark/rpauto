...
/**
 * Class PluginRpautoProfile
 */
class PluginRpautoProfile extends Profile
{
    ...
    public function getTabNameForItem(CommonGLPI $item, $withtemplate = 0)
    {
        if ($item->getType() == 'Profile' && $item->getField('interface') != 'helpdesk') {
            return _n('Rpauto survey', 'Rpauto surveys', 2, 'rpauto');
        }
        return '';
    }
    ...
    public static function displayTabContentForItem(CommonGLPI $item, $tabnum = 1, $withtemplate = 0)
    {
        if ($item->getType() == 'Profile') {
            ...
            self::addDefaultProfileInfos($ID, ['plugin_rpauto' => 0]);
            $prof->showForm($ID);
        }
        return true;
    }
    ...
    {
        //85
        self::addDefaultProfileInfos($ID, ['plugin_rpauto' => ALLSTANDARDRIGHT], true);
    }
